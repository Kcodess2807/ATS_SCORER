...
function ResultDashboard({ results, filename = 'resume' }) {
  ...
  console.log('ResultDashboard received results:', results)
  ...
  // Debug log to check component scores
  console.log('Component Scores Debug:', {
    raw: compScores,
    calculated: components.map(c => ({ name: c.name, score: c.score }))
  });
