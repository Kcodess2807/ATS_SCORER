            ...
            <div className="flex flex-col items-center mt-12 mb-16 animate-fade-in-up relative z-20" style={{ animationDelay: '200ms' }}>
              {isLoading ? (
                ...
                <div className={`relative group w-full sm:w-auto ${!resumeFile ? 'cursor-not-allowed' : ''}`}>
                  ...
                  {/*
                    📌 TEACHING NOTE — Why no disabled prop?
                    We removed disabled={!resumeFile} so the button always fires onClick.
                    handleAnalyzeClick() already checks for a missing file and shows a
                    helpful error message. With disabled, pointer-events-none blocks the
                    click entirely, giving the user zero feedback on why nothing happens.
                  */}
                  <Button
